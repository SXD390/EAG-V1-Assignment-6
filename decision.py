...
class DecisionLayer:
    ...
    async def decide(self, context: dict, system_prompt: str) -> LLMResponse:
        ...
        logger.debug(f"Context for decision: {context}")
...
- Ingredients Checked: {task_progress['ingredients_checked']}
        ...
        try:
            ...
            if response_type == "reasoning_block":
                ...
                if function == ActionType.FETCH_RECIPE.value:
                    ...
                    from models import GetPantryInput
                    parameters["params"] = GetPantryInput(**parameters.get("params", {}))
                    logger.debug("Created GetPantryInput")
